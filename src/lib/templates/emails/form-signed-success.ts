  		...
  		${document(`
            ...
            <div style="padding: clamp(20px, 5vw, 40px);">
                ...
                <div style="text-align: center; margin: 30px 0 20px 0;">
                    <a href="${parameters.signedFormUrl}" style="display: inline-block; padding: 14px 32px; background-color: #5ab3a0; color: #fcfcfd; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 15px;">
                        View Signed Form
                    </a>
                </div>
            ...
            ${footer({
							note: '',
							link: {
								url: parameters.manageSettingsLink,
