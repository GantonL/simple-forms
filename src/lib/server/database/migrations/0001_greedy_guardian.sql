...
VALUES (
  ...
  '{
    ...
    "direction": "rtl",
    "editableTextBlocks": [
      { "id": "title", "label": "templates.titles.consent_form", "content": "templates.content.consent_form_title" },
      { "id": "introduction", "label": "templates.sections.introduction", "content": "templates.content.introduction" },
      { "id": "terms", "label": "templates.sections.terms", "content": "templates.content.terms" },
      { "id": "confirmation", "label": "templates.sections.confirmation", "content": "templates.content.confirmation" },
      { "id": "admin_statement", "label": "templates.sections.admin_statement", "content": "templates.content.admin_statement" }
    ],
    "fields": [
